...
for i in dir_list:
    ...
    shutil.copy(source_dir + "save_frames.py" , target_dir + i + "/" + "save_frames.py")
    shutil.copy(source_dir + "save_we_input.py" , target_dir + i + "/" + "save_we_input.py")
...
for i in dir_list:
    ...
    os.system("python save_frames.py")
    os.system("python save_we_input.py")
